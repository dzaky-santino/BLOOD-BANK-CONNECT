    ...
    <div class=" vh-100 d-flex justify-content-center align-items-center">
        <div class="">
            ...
            <div class="bg-danger p-3 rounded-3 text-white">
                <h5 class="text-white">Segera Isi Formulinya</h5>
                <form action="{{ route('store_regist_tranfusi') }}" method="post">
                    @csrf
                    <input type="text" class="d-none" id="name" name="id_user" value="{{ Auth::user()->id }}">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="id_jadwal" class="form-label">Jadwal Tranfusi</label>
                    ...
                    <button type="submit" class="btn btn-primary">Daftar Tranfusi</button>
                </form>
            </div>
        </div>
